...
// 히스토리 목록 조회 응답
export interface LandingHistoryListResponseDto {
  histories: {
    id: number;
    date: string;
    title: string;
...
// 히스토리 생성 요청
export interface LandingHistoryCreateRequestDto {
  date: string;
  title: string;
  image_url?: string;
  gen?: number;
...
// 히스토리 생성 응답
export interface LandingHistoryCreateResponseDto {
  id: number;
  date: string;
  title: string;
  image_url: string | null;
...
// 히스토리 수정 요청
export interface LandingHistoryUpdateRequestDto {
  date?: string;
  title?: string;
  image_url?: string;
  gen?: number;
...
// 히스토리 수정 응답
export interface LandingHistoryUpdateResponseDto {
  id: number;
  date: string;
  title: string;
  image_url: string | null;
