    ...
    <div className={`relative ${className}`}>
      ...
      <div className="relative">
        <input
          ...
          className="w-full text-white px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
    ...
    <div className={`relative ${className}`}>
      ...
      <div className="relative">
        ...
        <input
          ...
          onBlur={handleBlur}
          placeholder={placeholder}
          className="w-full border border-[#404040] rounded-md px-10 py-3 bg-[#1A1A1A] text-white placeholder-[#e0e0e0] focus:border-[#c2402a] focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed"
          disabled={isLoadingMembers}
        />
        {isLoadingMembers && (
          <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
